...
metadata {
	definition(name: "SmartSense Multi Sensor Modified", namespace: "smartthings", author: "SmartThings", runLocally: false, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false) {
	...
	tiles(scale: 2) {
		...
		details(["temperature", "status", "acceleration", "battery", "refresh"])
	}
}
